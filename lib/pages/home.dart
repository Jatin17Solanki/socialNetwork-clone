...
//NOTE: this is an OPTIONAL FEATURE
  ...
  onPageChanged(int pIndex) //the function gets the index of the current page from the widget list
  {
    setState(() {
      pageIndex = pIndex;
    });
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: <Widget>[
          ...
          Search(),
          Profile(profileId: currentUser?.id) //if currentUser is not null then profileId equals currentUser.id
        ],
      ),
